...
from pydantic import BaseModel, ConfigDict, HttpUrl, Field, model_validator, field_serializer
...
class ApplicationRead(ApplicationBase):
    ...
    model_config = ConfigDict(from_attributes=True, json_schema_extra={"example": {
        ...
        "role": "Senior Frontend Engineer",
        "url": "https://example.com/jobs/123",
        "salary_min": 150000, "salary_max": 190000, "salary_target": 180000,
        "job_location": "REMOTE", "pipeline_status": "APPLIED",
        "next_follow_up_date": "2025-09-08", "resolution_status": "ONGOING",
        "created_at": "2025-09-02T15:04:05Z", "updated_at": "2025-09-02T16:00:00Z",
        "notes": "Intro screen this week",
        "interviews": [{
            "id": 7, "application_id": 42, "scheduled_date": "2025-09-05T19:00:00Z",
            "type": "PHONE_SCREEN", "notes": "Recruiter call",
            "created_at": "2025-09-02T15:04:05Z", "updated_at": "2025-09-02T16:00:00Z"
        }],
        "contacts": [{
            "id": 3, "name": "Jordan Lee", "company": "Circuit", "title": "Recruiter",
            "email": "jordan@circuit.com", "role": "recruiter",
            "created_at": "2025-09-02T15:04:05Z", "updated_at": "2025-09-02T16:00:00Z"
        }],
        "pipeline_histories": [{
            "id": 11, "changed_at": "2025-09-02T15:04:05Z",
            "from_status": "WILL_APPLY", "to_status": "APPLIED", "note": "Applied via site"
        }]
    }})
    ...
    pipeline_histories: List[PipelineHistoryRead] = []

    @field_serializer("interviews", when_used="always")
    def _serialize_interviews(self, v):
        # v is List[Interview] from ORM
        return [i.id for i in (v or [])]

    @field_serializer("contacts", when_used="always")
    def _serialize_contacts(self, v):
        # v is List[Contact] from ORM
        return [c.id for c in (v or [])]
